...
scales:{
  ...
  blocks:[
    ...
    { p:'A <b>pentatonic</b> scale is a normal scale with the two most argumentative notes taken out, leaving five. With five notes it is very hard to sound wrong. If your tunes keep clashing, write them in minor pentatonic first and add the other notes back one at a time.' },
...
chords:{
  ...
  blocks:[
    ...
    { p:'Look carefully: major and minor <em>both</em> have the 7. Only the middle note moves, by one key. One key is the entire difference between a happy chord and a heartbroken one.' },
...
progressions:{
  ...
  blocks:[
    ...
    { keys:[
      ...
      '<b>Wobbly</b> (chords V, vii°) — tension. It really wants to fall back home.' ] },
    ...
    { h:'Step 4 · The last two chords decide how it feels to stop' },
    { p:'The final pair of a phrase is called a <b>cadence</b>:' },
    { keys:[
      '<b>V → I</b> — a full stop. Completely finished.',
      '<b>IV → I</b> — a gentle landing, like an “amen”.',
      '<b>V → vi</b>, or ending on <b>V</b> — a comma. Keep going.' ] },
    { note:{ h:'Loops do not want an ending',
      p:'Modern music loops 4 or 8 bars forever, so you do not want a full stop — you want a chord that throws you back to bar 1. Make the <em>last</em> chord the wobbly one (V, or VII, or IV) and the loop pulls itself around.' } },
